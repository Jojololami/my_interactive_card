...
const nameOnCard = document.querySelector(".card_owner");
const numOnCard = document.querySelector(".card_number");
const expMM = document.querySelector(".expiry_month");
const expYY = document.querySelector(".expiry_year");
const cvcDisplay = document.querySelector(".pin_display");
